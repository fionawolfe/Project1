...
public class LowestCommonAncestorTest {
	...
	public void testNonExistentNode() {
		...
		assertEquals(-1, binaryTree15Nodes.LowestCommonAncestor(2, 17));
		assertEquals(-1, binaryTree15Nodes.LowestCommonAncestor(23, 17));
	}
	...
	public void outOfOrderTest() {
		...
		assertEquals("Lowest common ancestor of tree out of order", 5, binaryTreeOutOfOrder.LowestCommonAncestor(6, 4));
		assertEquals("Lowest common ancestor of tree out of order", 3, binaryTreeOutOfOrder.LowestCommonAncestor(3, 4));
		assertEquals("Lowest common ancestor of tree out of order", 1, binaryTreeOutOfOrder.LowestCommonAncestor(6, 2));
		assertEquals("Lowest common ancestor of tree out of order", 5, binaryTreeOutOfOrder.LowestCommonAncestor(7, 2));
	}
}
